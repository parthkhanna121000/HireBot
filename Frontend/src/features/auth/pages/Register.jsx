...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const data = await handleRegister({ username, email, password, role });
        ...
        <div className="hb-reg-left-inner">
          ...
          <div className="hb-reg-hero">
            ...
            <div className="hb-reg-steps">
              <Step num="1" delay="0.28s" title="Upload your resume"       desc="Drop in any format — PDF, DOC, or DOCX" />
              <Step num="2" delay="0.36s" title="Get your AI match score"  desc="See exactly how you stack up against any job" />
              <Step num="3" delay="0.44s" title="Fix gaps & apply"         desc="Use AI suggestions to stand out from the crowd" />
            </div>
          </div>
            ...
            <div className="hb-reg-field">
              ...
              {password && (
                <div className="hb-reg-strength">
                  ...
                  <span className="hb-reg-strength-label" style={{ color: strength.color }}>
                    {strength.label}
                  </span>
                </div>
              )}
